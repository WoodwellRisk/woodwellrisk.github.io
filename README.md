...
## Contributing
If you are a member of the organization, you can easily contribute. To do so, you should clone this repository onto your local machine and install the `conda` environment.  Once you have your environment set up, you can start making edits and / or additions. To view local changes before pushing them to this repository, you can run a local server and open it in your browser. If everything is working, you can then use this command to see a live version of the site as you make changes:
```
mkdocs serve
```

You can then add, commit, and push your changes. Once GitHub receives your pushed changes, it will automatically rebuild and deploy the website.
